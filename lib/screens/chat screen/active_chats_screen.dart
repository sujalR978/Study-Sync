...
class _ActiveChatsScreenState extends State<ActiveChatsScreen>
  ...
  Future<void> _setupFCMToken() async {
    ...
    // 1. Request permission for notifications (iOS & Android 13+)
    ...
    if (settings.authorizationStatus == AuthorizationStatus.authorized) {
      ...
      if (token != null && FirebaseAuth.instance.currentUser != null) {
        ...
        // 3. Save it to the user's document in Firestore
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSelected
              ? primaryColor
              : surfaceColor.withOpacity(isDark ? 0.3 : 0.5),
          borderRadius: BorderRadius.circular(100),
          border: Border.all(
            color: isSelected
                ? Colors.transparent
        ...
        child: Text(
          label,
          style: TextStyle(
            color: isSelected ? Colors.white : onSurfaceColor.withOpacity(0.7),
            fontWeight: FontWeight.bold,
            fontSize: 13,
          ),
        ),
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (_) => PrivateChatScreen(
                      ...
                      otherUserAvatarText: groupName.isNotEmpty
          ...
          child: Material(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    // --- REPLACED CircleAvatar WITH ProfileAvatar ---
                    ProfileAvatar(
                      photoUrl: photoUrl,
                      isOnline: isOnline,
                      radius: 26,
